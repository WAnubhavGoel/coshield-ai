...
-- CreateEnum
CREATE TYPE "Role" AS ENUM ('USER', 'COMPLIANCE_OFFICER', 'ADMIN');
...
CREATE TABLE "Document" (
    ...
    "roleRequired" "Role" NOT NULL DEFAULT 'USER',
    "departmentId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "DocumentChunk" ADD CONSTRAINT "DocumentChunk_departmentId_fkey" FOREIGN KEY ("departmentId") REFERENCES "Department"("id") ON DELETE SET NULL ON UPDATE CASCADE;
